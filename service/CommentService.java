...
public class CommentService {
  ...
  public static void makeDummyCmtData(int n) throws Exception { //댓글 더미데이터 생성 메소드
    for(int i=0;i<n;i++){
  ...
  public static void loadCmtData() throws Exception { //데이터 로드
  ...
  public static void deleteCmd() throws Exception { //댓글 삭제
  ...
  public static void CmtFileCover() throws Exception { //댓글 파일 덮어쓰기 메소드
  ...
  public static void createCmt() throws Exception { //댓글 달기 메소드
    if(MemberService.loginMember==null){
